 ...
 */
void vapash_keccakf1600(uint64_t state[25]) NOEXCEPT;
 ...
 */
void vapash_keccakf800(uint32_t state[25]) NOEXCEPT;

union vapash_hash256 vapash_keccak256(const uint8_t* data, size_t size) NOEXCEPT;
union vapash_hash256 vapash_keccak256_32(const uint8_t data[32]) NOEXCEPT;
union vapash_hash512 vapash_keccak512(const uint8_t* data, size_t size) NOEXCEPT;
union vapash_hash512 vapash_keccak512_64(const uint8_t data[64]) NOEXCEPT;
