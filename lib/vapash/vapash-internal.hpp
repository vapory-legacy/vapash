...
/// @file
/// Contains declarations of internal vapash functions to allow them to be
/// unit-tested.
...
extern "C" struct vapash_epoch_context_full : vapash_epoch_context
{
    vapash_hash1024* full_dataset;

    constexpr vapash_epoch_context_full(int epoch_number, int light_cache_num_items,
        const vapash_hash512* light_cache, const uint32_t* l1_cache, int full_dataset_num_items,
        vapash_hash1024* full_dataset) noexcept
      : vapash_epoch_context{epoch_number, light_cache_num_items, light_cache, l1_cache,
